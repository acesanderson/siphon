...
class GitHubEnricher(EnricherStrategy):
    """Enrich GitHub repository content with LLM."""
    ...
    async def enrich(
        ...
        description_str = self.prompt_loader["github_description"].render(input_variables)
        summary_str = self.prompt_loader["github_summary"].render(input_variables)
